...
import com.example.springsecutiryexemple.jwt.JwtAccessDeniedHandler;
import com.example.springsecutiryexemple.jwt.JwtAuthenticationEntryPoint;
import com.example.springsecutiryexemple.jwt.JwtAuthorizationFilter;
...
import static com.example.springsecutiryexemple.utils.Utils.PUBLIC_URLS;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception{
        ...
        httpSecurity.csrf().disable().cors().and()
                ...
                .authenticationEntryPoint(jwtAuthenticationEntryPoint)//se verifica daca se paote accesa acest endpoint
                .and()
